  ...
  ARangePicker: {
    ...
    transfer: {
      input(value, {
        ...
        if (Util.isArray(value)) {
          return value.filter(every => Util.isString(every)).map(every => Util.isString(every) ? moment__default["default"](every, col.attrs.format || 'YYYY-MM-DD') : null);
        }
        return [];
      },
      output(value, {
        ...
        if (Util.isArray(value)) {
          return value.map(every => Util.isObject(every) ? every.format(col.attrs.valueFormat || col.attrs.format || 'YYYY-MM-DD') : '');
        }
        return [];
      }
    },
    ...
    transfer: {
      input(value, {
        ...
        if (value === undefined || Util.isNumber(value) || Util.isString(value)) {
          if (value) {
            return moment__default["default"](value, col.attrs.format || 'YYYY');
          }
          return null;
        }
        return value;
  ...
  AMonthPicker: {
    ...
    transfer: {
      input(value, {
        ...
        if (value === undefined || Util.isNumber(value) || Util.isString(value)) {
          if (value) {
            return moment__default["default"](value, col.attrs.format || 'YYYY-MM');
          }
          return null;
        }
        return value;
  ...
  ADatePicker: {
    ...
    transfer: {
      input(value, {
        ...
        if (value === undefined || Util.isNumber(value) || Util.isString(value)) {
          if (value) {
            return moment__default["default"](value, col.attrs.format || (col.attrs.showTime ? 'YYYY-MM-DD HH:mm:ss' : 'YYYY-MM-DD'));
          }
          return null;
        }
        return value;
  ...
  ATimePicker: {
    ...
    transfer: {
      input(value, {
        ...
        if (value === undefined || Util.isNumber(value) || Util.isString(value)) {
          if (value) {
            return moment__default["default"](value, col.attrs.format || (col.attrs.use12Hours ? 'h:mm:ss' : 'HH:mm:ss'));
          }
          return null;
        }
        return value;
